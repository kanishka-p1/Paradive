    ...
    return (
        <div className='allActivity'>
            ...
            <div className="activities">
                ...
                <div className="activityRow">
                    <ActivityCard
                        src={activities[6].src}
                        name={activities[6].name}
                    />
                    <ActivityCard
                        src={activities[7].src}
                        name={activities[7].name}
                    />
                    <ActivityCard
                        src={activities[8].src}
                        name={activities[8].name}
                    />
                </div>

                <div className="activityRow">
                    <ActivityCard
                        src={activities[9].src}
                        name={activities[9].name}
                    />
                    <ActivityCard
                        src={activities[10].src}
                        name={activities[10].name}
                    />
                    <ActivityCard
                        src={activities[11].src}
                        name={activities[11].name}
                    />
                </div>
            </div>
            <Footer />
